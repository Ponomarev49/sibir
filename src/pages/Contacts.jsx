...
export default function Contacts() {
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white pt-20 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col items-center text-gray-800">
        {/* Заголовки */}
        <h2 className="text-[32px] font-extrabold text-blue-900 text-center">
          Президент
        </h2>
        ...
        {/* Имя */}
        <p className="py-5 text-[28px] md:text-[32px] font-semibold text-center">
        ...
        <img
          ...
          className="w-full max-w-[400px] md:max-w-[500px] rounded-lg shadow-lg hover:scale-105 transition duration-300 mb-8"
        />
